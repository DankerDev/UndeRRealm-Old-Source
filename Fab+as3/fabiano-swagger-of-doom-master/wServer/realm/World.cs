...
namespace wServer.realm
{
    public abstract class World : IDisposable
    {
        ...
        public const int ENTRANCE_ID = -15;
        ...
        {
            return !(this is Nexus) && !(this is GameWorld) && !(this is ClothBazaar) && !(this is Test) && !(this is GuildHall) && !(this is Tutorial) && !(this is WackaMoleEntrance) && !(this is DailyQuestRoom) && !IsLimbo;
        }
