...
using wServer.realm.entities; //a
using wServer.realm.entities.player; //a
using wServer.realm.worlds; //a
...
namespace wServer.realm
{
    ...
    public class RealmManager
    {
        ...
        public void Initialize()
        {
            ...
            AddWorld(World.ENTRANCE_ID, new WackaMoleEntrance(true));
