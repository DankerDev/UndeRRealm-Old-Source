    ...
    partial class BehaviorDb
    {
        ...
        #region 1stbosschest
            .Init("shtrs Loot Balloon Bridge",
                ...
                new Threshold(0.1,
                    new TierLoot(11, ItemType.Weapon, 0.9),
                    new TierLoot(12, ItemType.Weapon, 0.8),
                    new TierLoot(6, ItemType.Ability, 0.4),
                    new TierLoot(12, ItemType.Armor, 0.7),
                    new TierLoot(13, ItemType.Armor, 0.5),
        ...
        #region 2ndbosschest
            .Init("shtrs Loot Balloon Mage",
                ...
                new Threshold(0.1,
                    new TierLoot(11, ItemType.Weapon, 0.8),
                    new TierLoot(12, ItemType.Weapon, 0.7),
        ...
        #region BridgeStatues
                ...
                new State(
                    ...
                    new State("Shoot",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                            ...
                            new NoPlayerWithinTransition(15, "pause"),
                            new NoPlayerWithinTransition(20, "pause3"),
                            new PlayerWithinTransition(3, "pause2")
                    ...
                    new State("pause2",
                        new Reproduce("shtrs Stone Knight", 1),
                        new Reproduce("shtrs Stone Mage", 1),
                        new TimedTransition(7000, "Shoot")
                            ),
                    new State("pause3",
                        new ConditionalEffect(ConditionEffectIndex.Armored),
            ...
            .Init("shtrs Bridge Obelisk C",                                                     //YELLOW TOWERS!
                new State(
                    ...
                    new State("pause2",
                        new Reproduce("shtrs Stone Paladin", 1),
                        new TimedTransition(7000, "Shoot")
                        ),
                    new State("pause3",
                        new ConditionalEffect(ConditionEffectIndex.Armored),
        ...
        #region SomeMobs
            .Init("shtrs Titanum",
                new State(
                    ...
                    new State("spawn",
                        new Spawn("shtrs Stone Knight", coolDown: 5000),
                        new Spawn("shtrs Stone Mage", coolDown: 7500),
                        new EntityNotExistsTransition2("shtrs Stone Mage", "shtrs Stone Knight", 1000, "Wait2")
                            ),

                    new State("Wait2",
                        new Spawn("shtrs Stone Knight", coolDown: 5000),
                        new EntityNotExistsTransition("shtrs Stone Knight", 1000, "Wait")
                        )
                    )
            )
            .Init("shtrs Paladin Obelisk",
                new State(
                    ...
                    new State("spawn",
                        new Spawn("shtrs Stone Paladin", coolDown: 3500),
                        new EntityNotExistsTransition("shtrs Stone Paladin", 2000, "Wait")
        ...
        #region 3rdbosschest
            .Init("shtrs Loot Balloon King",
                ...
                new Threshold(0.1,
                    ...
                    new TierLoot(12, ItemType.Armor, 0.7),
                    new TierLoot(13, ItemType.Armor, 0.5),
                    new TierLoot(6, ItemType.Ring, 0.6),
                new Threshold(0.32,
