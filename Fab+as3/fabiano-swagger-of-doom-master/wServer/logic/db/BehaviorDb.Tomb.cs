        ...
        private _ Tomb = () => Behav()
            .Init("Tomb Defender",                                         //Tomb Defender == Bes; His rage phase is perfectly working, needs no adjustments, but
                ...
                new State(
                    ...
                    new State("weakning",
                        new Orbit(.6, 5, target: "Tomb Boss Anchor", radiusVariance: 0.5),
                        new Taunt(true, "Impudence! I am an immortal, I needn't take you seriously."),
                    ...
                    new State("active",
                        ...
                        new Taunt(true, "The others use tricks, but I shall stun you with my brute strength!"),
                    ...
                    new State("triple shot",
                        new ConditionalEffect(ConditionEffectIndex.Armored),
                        new Orbit(.6, 5, target: "Tomb Boss Anchor", radiusVariance: 0.5),
                        new Taunt(true, "Awe at my wondrous defense!"),
                        new Shoot(50, 8, projectileIndex: 2, coolDown: 1000, coolDownOffset: 500),
                        new Shoot(50, 8, 10, 1, coolDown: 4750, coolDownOffset: 500),
            ...
            .Init("Tomb Support",                                               //tomb support == Nut; I added my own rage phase, because Fabiano's didn't have
                ...
                new State(
                    ...
                    new State("active",
                        new Orbit(.7, 5, target: "Tomb Boss Anchor", radiusVariance: 0.5),
                        new Taunt(true, "Bes, become my wall of defense!"),
                    ...
                    new State("boomerang",
                        new ConditionalEffect(ConditionEffectIndex.Armored),
                        new Taunt(true, "My attacks shall make your lethargic lives end much more switfly!"),
                        new Orbit(.6, 5, target: "Tomb Boss Anchor", radiusVariance: 0.5),
            ...
            .Init("Tomb Attacker",                                    //Tomb Attacker == Geb; I added my own rage phase, again, because Fabiano's didn't have anything from
                ...
                new State(
                    ...
                    new State("weakning",
                        new Orbit(.6, 5, target: "Tomb Boss Anchor", radiusVariance: 0.5),
                        new Taunt(true, "I shall destroy you from your soul to your flesh!"),
                        new Shoot(50, 24, projectileIndex: 3, coolDown: 6000, coolDownOffset: 2000),
            ...
            .Init("Tomb Support Statue",
                new State(
                    new State(
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new EntityNotExistsTransition("Active Sarcophagus", 1000, "checkActive"),
                        new EntityExistsTransition("Active Sarcophagus", 1000, "Active2")
                        ),
                    new State("checkActive",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new EntitiesNotExistsTransition(2500, "ItsGoTime", "Active Sarcophagus", "Inactive Sarcophagus")
                        ),
                    new State("Active2",
                        new EntitiesNotExistsTransition(2500, "ItsGoTime", "Active Sarcophagus", "Inactive Sarcophagus")
                        ),
            ...
            .Init("Tomb Attacker Statue",
                new State(
                    new State("Idle",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new EntityNotExistsTransition("Active Sarcophagus", 2500, "checkActive")
                        ),
                    new State("checkActive",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new EntityNotExistsTransition2("Active Sarcophagus", "Inactive Sarcophagus", 2500, "ItsGoTime")
                        ),
                    new State("ItsGoTime",
            ...
            .Init("Inactive Sarcophagus",
                new State(
                    new State("Idle",
                        ...
                        new EntityNotExistsTransition("Beam Priest", 14, "checkPriestess")
                        ),
                    new State("checkPriest",
                        new EntityNotExistsTransition("Beam Priest", 14, "activate")
                        ),
                    new State("checkPriestess",
                        new EntityNotExistsTransition("Beam Priestess", 14, "activate")
                        ),
                    new State("activate",
        ...
        .Init("Jackal Assassin",
            ...
            .Init("Active Sarcophagus",
                new State(
                    ...
                    new State("stun",
                        new Shoot(50, projectileIndex: 0, count: 8, fixedAngle: 0, coolDown: 1250, coolDownOffset: 500),
                        new Shoot(50, projectileIndex: 0, count: 8, fixedAngle: 45, coolDown: 1250, coolDownOffset: 500),
                        new Shoot(50, projectileIndex: 0, count: 8, fixedAngle: 90, coolDown: 1250, coolDownOffset: 500),
                        new Shoot(50, projectileIndex: 0, count: 8, fixedAngle: 135, coolDown: 1250, coolDownOffset: 500),
                        new Shoot(50, projectileIndex: 0, count: 8, fixedAngle: 180, coolDown: 1250, coolDownOffset: 500),
