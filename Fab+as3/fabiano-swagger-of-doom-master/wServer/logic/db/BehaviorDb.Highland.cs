        ...
        private _ Highland = () => Behav()
            ...
            .Init("Ogre Warrior",
                new State(
                    ...
                    new Prioritize(
                        ...
                        new Follow(1, 10.5, 1.6, 2600, 2200),
                        new Orbit(0.6, 6),
                        new Wander(0.4)
                        )
                    ),
            ...
            .Init("White Dragon Whelp",
                new State(
                    ...
                    new Prioritize(
                        new StayAbove(1, 150),
                        new Follow(1.5, range: 2.5, acquireRange: 10.5, duration: 2200, coolDown: 3200),
                        new Wander(0.9)
                        )
                    )
            )
            .Init("Juvenile White Dragon",
                new State(
                    ...
                    new Prioritize(
                        new StayAbove(9, 150),
                        new Follow(1.5, range: 2.2, acquireRange: 10.5, duration: 3000, coolDown: 3000),
                        new Wander(0.75)
                        )
                    ),
            ...
            .Init("Adult White Dragon",
                new State(
                    ...
                    new Prioritize(
                        new StayAbove(9, 150),
                        new Follow(1.3, range: 1.8, acquireRange: 10.5, duration: 4000, coolDown: 2000),
                        new Wander(0.75)
                        )
                    ),
                new ItemLoot("Health Potion", 0.03),
