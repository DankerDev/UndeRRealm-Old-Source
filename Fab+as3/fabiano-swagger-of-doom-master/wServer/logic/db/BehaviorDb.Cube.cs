                ...
                new State(
                    new StayCloseToSpawn(0.3, range: 7),
                           new Wander(0.5),
                             ...
                             new Spawn("Cube Overseer", maxChildren: 2, initialSpawn: 2, coolDown: 20000),
                             new Spawn("Cube Defender", maxChildren: 2, initialSpawn: 5, coolDown: 20000),
                             new Spawn("Cube Blaster", maxChildren: 2, initialSpawn: 2, coolDown: 20000)
                ),
                new Threshold(1.0,
