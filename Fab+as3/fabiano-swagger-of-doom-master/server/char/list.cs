    ...
    internal class list : RequestHandler
    {
        ...
        private List<ClassAvailabilityItem> GetClassAvailability(Account acc)
        {
            ...
            if (acc == null)
            {
                ...
                {
                    new ClassAvailabilityItem {Class = "Rogue", Restricted = "unrestricted"}, //a
                    ...
                    new ClassAvailabilityItem {Class = "Archer", Restricted = "unrestricted"}, //a
                    new ClassAvailabilityItem {Class = "Wizard", Restricted = "unrestricted"}, //a
                    new ClassAvailabilityItem {Class = "Priest", Restricted = "unrestricted"}, //a
                    new ClassAvailabilityItem {Class = "Necromancer", Restricted = "Restricted"},
                    new ClassAvailabilityItem {Class = "Warrior", Restricted = "unrestricted"}, //a
                    ...
                    new ClassAvailabilityItem {Class = "Paladin", Restricted = "restricted"},
                     new ClassAvailabilityItem {Class = "Soul Reaper", Restricted = "restricted"},
                };
            }
