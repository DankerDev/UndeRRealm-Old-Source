...
public class ActivateEffect
{
    public ActivateEffect(XElement elem)
    {
        ...
        dontStack = elem.Attribute("dontStack") != null;
    }

    public ActivateEffects Effect { get; private set; }
    public int Stats { get; private set; }
    public int Amount { get; private set; }
    public bool dontStack { get; private set; }
...
public class Item : IFeedable
{
    ...
    private const bool DISABLE_DIVINE_DVN = false;
    ...
    public Item(ushort type, XElement elem)
    {
        try
        {
            ...
            if (elem.Element("Divine") != null)
            {
                var s = Utils.FromString(elem.Element("SlotType").Value);
                if (s == 10 || s == 26 || elem.Element("ActivateOnEquip") == null || !DISABLE_DIVINE_DVN)
                    Divine = true;
                else Divine = false;
            }
            ...
            HpEndCost = (n = elem.Element("HpEndCost")) != null ? int.Parse(elem.Element("HpEndCost").Value) : null as int?;
    ...
    public bool Divine { get; private set; }
    ...
    public int? HpEndCost { get; private set; }
