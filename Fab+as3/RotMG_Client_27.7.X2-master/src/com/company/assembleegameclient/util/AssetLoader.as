...
public class AssetLoader {
    ...
    private function addImages():void {
        ...
        AssetLibrary.addImageSet("d2LofiObj", new EmbeddedAssets.d2LofiObjEmbed_().bitmapData, 8, 8);
        AssetLibrary.addImageSet("lofiObj8", new EmbeddedAssets.lofiObj8Embed_().bitmapData, 24, 24);
    ...
    private function addAnimatedCharacters():void {
        ...
        AnimatedChars.add("chars32x32dFrost", new EmbeddedAssets.chars32x32dFrostEmbed_().bitmapData, null, 32, 32, 224, 32, AnimatedChar.DOWN);
