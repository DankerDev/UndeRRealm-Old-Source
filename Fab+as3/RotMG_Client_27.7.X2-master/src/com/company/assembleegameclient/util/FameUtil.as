...
public class FameUtil {
    ...
    public static const STARS:Vector.<int> = new <int>[20, 150, 400, 800, 2000, 6000];
    ...
    private static const neonCT:ColorTransform = new ColorTransform((0 / 0xFF), (225 / 0xFF), (225 / 0xFF));
    public static const COLORS:Vector.<ColorTransform> = new <ColorTransform>[lightBlueCT, darkBlueCT, redCT, orangeCT, yellowCT, neonCT];
            ...
            if (_arg_1 < (ObjectLibrary.playerChars_.length * 2)) {
                ...
                if (_arg_1 < (ObjectLibrary.playerChars_.length * 3)) {
                    ...
                    if (_arg_1 < (ObjectLibrary.playerChars_.length * 4)) {
                        ...
                        else if (_arg_1 < ObjectLibrary.playerChars_.length * 6) {
                            _local_2.transform.colorTransform = neonCT;
                        }
                    }
                }
            }
