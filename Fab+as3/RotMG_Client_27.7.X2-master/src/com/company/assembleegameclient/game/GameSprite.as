...
public class GameSprite extends AGameSprite
{
    ...
    {
        var _local1:Account = null;
        var _local4:ShowProTipSignal = null;
        map.initialize();
    ...
    {
        var _local3:NewsModalButton = null;
    ...
    private function updateNearestInteractive() : void
    {
        ...
        var _local7:GameObject = null;
        var _local8:IInteractiveObject = null;
        var _local3:IInteractiveObject = null;
        if(!map || !map.player_)
        {
            return;
        }
    ...
    public function onScreenResize(_arg1:Event) : void
    {
        ...
        {
            this.map.scaleX = _local12 * (stage.scaleMode != StageScaleMode.NO_SCALE?Parameters.data_["mscale"]:0.7);
            this.map.scaleY = _local13 * (stage.scaleMode != StageScaleMode.NO_SCALE?Parameters.data_["mscale"]:0.7);
        }
        if(this.hudView != null)
        {
            if(_local2)
            {
                this.hudView.x = stage.stageWidth/800;
            ...
            {
                this.creditDisplay_.x = 180 * this.creditDisplay_.scaleX;
                this.creditDisplay_.y = 110 * this.creditDisplay_.scaleY;
            }
        }
        if(this.newsModalButton != null)
        {
        ...
        if(this.chatBox_ != null)
        {
            ...
            this.chatBox_.y = 280 + 280 * (1 - this.chatBox_.scaleY);
        }
    ...
    private function onEnterFrame(param1:Event) : void
    {
        ...
        this.onScreenResize(param1);
        var _local5:Player = map.player_;
        if(this.focus)
        {
            camera_.configureCamera(this.focus,!!_local5?Boolean(Boolean(_local5.isHallucinating())):Boolean(false));
