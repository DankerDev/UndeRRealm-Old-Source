...
public class CharacterBox extends Sprite {
    ...
    public function CharacterBox(_arg_1:XML, _arg_2:CharacterStats, _arg_3:PlayerModel, _arg_4:Boolean = false) {
        ...
        this.classNameText_ = new TextFieldDisplayConcrete().setSize(15).setColor(0xFFFFFF).setAutoSize(TextFieldAutoSize.CENTER).setTextWidth(this.graphic_.width).setBold(false);
    ...
    private function setStatusButton():void {
        this.statusText_ = new TextFieldDisplayConcrete().setSize(15).setColor(0xFF0000).setAutoSize(TextFieldAutoSize.CENTER).setBold(false).setTextWidth(this.graphic_.width);
    ...
    private function setSaleText():void {
        this.saleText_ = new TextFieldDisplayConcrete().setSize(15).setColor(0xFFFFFF).setAutoSize(TextFieldAutoSize.CENTER).setBold(false).setTextHeight(this.saleTag_.height).setTextWidth(this.saleTag_.width);
        this.saleText_.x = 42;
        this.saleText_.y = 12;
    }

    private function getCharacterUnlockText():void {
        this.unlockedText_ = new TextFieldDisplayConcrete().setSize(15).setColor(0xFF00).setBold(false).setAutoSize(TextFieldAutoSize.CENTER);
