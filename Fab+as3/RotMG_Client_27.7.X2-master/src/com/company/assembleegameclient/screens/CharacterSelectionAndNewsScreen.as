...
public class CharacterSelectionAndNewsScreen extends Sprite {
    ...
    private static const NEWS_X:int = 500;
    ...
    private function makeMenuOptionsBar():void {
        ...
        this.menuOptionsBar.addButton(this.playButton, MenuOptionsBar.PLAYBOTTON);
        this.menuOptionsBar.addButton(this.backButton, MenuOptionsBar.BACKBOTTON);
        this.menuOptionsBar.addButton(this.classesButton, MenuOptionsBar.CLASSBOTTON);
