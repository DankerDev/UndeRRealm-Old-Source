package com.company.assembleegameclient.map
{
   ...
   public class Camera
   {
      ...
      public static function resetDimensions() : void
      {
         ...
         var _local4:Number = Boolean(Parameters.data_["uiscale"])?Number(_local3 / 3):Number(200 / _local1);
      ...
      {
         var _local3:Rectangle = this.GetViewingRect(Parameters.data_.centerOnPlayer);
         if(Parameters.screenShotMode_)
         {
            _local3 = !!Parameters.screenShotSlimMode_?SLIM_SCREENSHOT_SCREEN_RECT:SCREENSHOT_SCREEN_RECT;
         }
      ...
      public function configure(param1:Number, param2:Number, param3:Number, param4:Number, param5:Rectangle) : void
      {
         ...
         this.maxDist_ = Math.sqrt(_local6 * _local6 + _local7 * _local7) + 16;
