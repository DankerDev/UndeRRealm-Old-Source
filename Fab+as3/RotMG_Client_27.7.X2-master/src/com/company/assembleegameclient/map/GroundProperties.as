package com.company.assembleegameclient.map
{
   ...
   public class GroundProperties
   {
      ...
      public function GroundProperties(param1:XML)
      {
         ...
         this.xOffset_ = !!param1.hasOwnProperty("XOffset")?Number(Number(Number(param1.XOffset))):Number(Number(0));
         this.yOffset_ = !!param1.hasOwnProperty("YOffset")?Number(Number(Number(param1.YOffset))):Number(Number(0));
         this.push_ = param1.hasOwnProperty("Push");
