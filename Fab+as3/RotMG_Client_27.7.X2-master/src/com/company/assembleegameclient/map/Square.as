package com.company.assembleegameclient.map
{
   ...
   public class Square
   {
      ...
      public function Square(_arg1:com.company.assembleegameclient.map.Map, _arg2:int, _arg3:int)
      {
      ...
      private static function hash(_arg1:int, _arg2:int) : int
      {
         ...
         _local4 = _local4 * _local3 % 65535;
         return _local4;
      }
      
      public function dispose() : void
      {
         var _local1:com.company.assembleegameclient.map.SquareFace = null;
         this.map_ = null;
         this.center_ = null;
         this.vin_ = null;
         this.obj_ = null;
      ...
      {
         var _local4:com.company.assembleegameclient.map.SquareFace = null;
      ...
      private function rebuild3D() : void
      {
         ...
         var _local5:Vector.<Number> = null;
         var _local6:uint = 0;
         ...
         if(this.props_.animate_.type_ != AnimateProperties.NO_ANIMATE)
         {
            ...
            if(_local1 != null)
            {
               this.faces_.push(new com.company.assembleegameclient.map.SquareFace(_local1,this.vin_,0,0,AnimateProperties.NO_ANIMATE,0,0));
            }
         }
         else
         {
            ...
            this.faces_.push(new com.company.assembleegameclient.map.SquareFace(_local1 != null?_local1:this.texture_,this.vin_,_local2,_local3,AnimateProperties.NO_ANIMATE,0,0));
         }
         if(this.props_.sink_)
         {
            this.sink_ = _local1 == null?int(12):int(6);
         }
         else
         {
            this.sink_ = 0;
         ...
         if(this.props_.topTD_)
         {
            ...
            this.topFace_ = new com.company.assembleegameclient.map.SquareFace(_local4,_local5,0,0,this.props_.topAnimate_.type_,this.props_.topAnimate_.dx_,this.props_.topAnimate_.dy_);
         }
      }
   }
}
