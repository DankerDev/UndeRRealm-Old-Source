...
public class TeleportMenuOption extends MenuOption {
    ...
    public function TeleportMenuOption(_arg_1:Player) {
        ...
        super(AssetLibrary.getImageFromSet("lofiInterface2", 3), 0xBFFFF9, TextKey.TELEPORTMENUOPTION_TITLE);
        this.player_ = _arg_1;
        this.barText_ = new TextFieldDisplayConcrete().setSize(20).setColor(0xFFFFFF);
