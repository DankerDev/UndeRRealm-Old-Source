...
public class Slot extends Sprite {
    ...
    public static const REAPER_TYPE:int = 25;
    public static const WIDTH:int = 40;
    public static const HEIGHT:int = 40;
    public static const BORDER:int = 5;
    private static const greyColorFilter:ColorMatrixFilter = new ColorMatrixFilter(MoreColorUtil.singleColorFilterMatrix(0x4902107));
    ...
    public function Slot(_arg_1:int, _arg_2:int, _arg_3:Array) {
        this.fill_ = new GraphicsSolidFill(0x15269887, 1);
    ...
    protected function drawBackground():void {
        ...
        GraphicsUtil.drawCutEdgeRect(1, 1, WIDTH, HEIGHT, 4, this.cuts_, this.path_);
        graphics.clear();
        ...
        switch (this.type_) {
            ...
            case SCEPTER_TYPE:
                ...
                break;
            case REAPER_TYPE:
                _local_1 = AssetLibrary.getImageFromSet("lofiObj7", 64);
                break;
        }
