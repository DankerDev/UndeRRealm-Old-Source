...
public class OfferRadioButton extends Sprite implements Selectable {
    ...
    public function getValue():String {
        return (this.offer.realmCoin_.toString());
    }
    ...
    private function makeCoinText():void {
        this.goldText = new TextFieldDisplayConcrete().setSize(18).setColor(0xFFFFFF).setBold(true);
        this.goldText.setStringBuilder(new LineBuilder().setParams(TextKey.PAYMENTS_COIN_AMOUNT, {"amount": this.offer.realmCoin_}));
    ...
    private function makeBonusText():void {
        ...
        this.bonusText.setStringBuilder(new LineBuilder().setParams(TextKey.PAYMENTS_COIN_BONUS, {"percent": this.offer.bonus}));
