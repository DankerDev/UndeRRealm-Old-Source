...
public class OfferRadioButtons extends Sprite {
    ...
    public function OfferRadioButtons(_arg_1:Offers, _arg_2:MoneyConfig) {
        this.offers = _arg_1;
        this.config = _arg_2;
        this.makeCoinChoices();
        this.alignCoinChoices();
    ...
    private function makeCoinChoices():void {
        var _local_1:int = this.offers.offerList.length;
        this.choices = new Vector.<OfferRadioButton>(_local_1, true);
        var _local_2:int;
        while (_local_2 < _local_1) {
            this.choices[_local_2] = this.makeCoinChoice(this.offers.offerList[_local_2]);
            _local_2++;
        }
    }

    private function makeCoinChoice(_arg_1:Offer):OfferRadioButton {
    ...
    private function alignCoinChoices():void {
