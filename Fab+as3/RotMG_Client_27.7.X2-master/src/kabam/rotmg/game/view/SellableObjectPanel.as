...
public class SellableObjectPanel extends Panel implements TooltipAble {
    ...
    public function SellableObjectPanel(_arg_1:GameSprite, _arg_2:SellableObject) {
        ...
        super(_arg_1);
        this.nameText_ = new TextFieldDisplayConcrete().setSize(17).setColor(0x545454).setTextWidth((WIDTH - 44));
        this.nameText_.setBold(false);
    ...
    private static function createRankReqText(rankReq:int):Sprite {
        ...
        requiredText = new TextFieldDisplayConcrete().setSize(18).setColor(0x545454).setBold(false).setAutoSize(TextFieldAutoSize.CENTER);
    ...
    private static function createGuildRankReqText(_arg_1:int):TextFieldDisplayConcrete {
        ...
        _local_2 = new TextFieldDisplayConcrete().setSize(16).setColor(0xFF0000).setBold(false).setAutoSize(TextFieldAutoSize.CENTER);
