...
public class LegendsView extends Sprite {
    ...
    private function makeTitleText():void {
        this.title = new TextFieldDisplayConcrete().setSize(34).setColor(0x696969);
    ...
    private function makeLoadingBanner():void {
        this.loadingBanner = new TextFieldDisplayConcrete().setSize(22).setColor(0x696969);
    ...
    private function makeScrollbar():void {
        ...
        this.scrollBar.x = ((800 - this.scrollBar.width) - 5);
    ...
    private function makeCloseButton():void {
        this.closeButton = new TitleMenuOption(TextKey.EXIT_TEXT, 36, false);
