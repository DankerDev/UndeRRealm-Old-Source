...
public class ChatListItemFactory {
    ...
    private static const SPECIAL:String = Parameters.SPECIAL_CHAT;//*Special*
    ...
    private function isSpecialMessageType():Boolean {
        ...
        return ((((((((((_local_1 == SERVER)) || ((_local_1 == CLIENT)))) || ((_local_1 == HELP)))) || ((_local_1 == ERROR)))) || ((_local_1 == SPECIAL)))) || ((_local_1 == GUILD));
    }
    ...
    private function getNameColor():uint {
        ...
        if (this.message.recipient == SPECIAL)
        {
            return (55494);
        }
