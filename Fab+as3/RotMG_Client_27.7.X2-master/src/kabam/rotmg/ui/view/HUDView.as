...
public class HUDView extends Sprite implements UnFocusAble {
    ...
    private const BG_POSITION:Point = new Point(654, 74);
    private const MAP_POSITION:Point = new Point(660, 80);
    private const CHARACTER_DETAIL_PANEL_POSITION:Point = new Point(0, 40);
    private const STAT_METERS_POSITION:Point =  new Point(5, 70);
    private const EQUIPMENT_INVENTORY_POSITION:Point = new Point(615, 300);
    private const TAB_STRIP_POSITION:Point = new Point(610, 350);
    private const INTERACT_PANEL_POSITION:Point = new Point(630, 475);
    ...
    private function createAssets():void {
        ...
        this.miniMap = new MiniMapImp(120, 120);
    ...
    private function createInteractPanel(_arg_1:GameSprite):void {
        this.interactPanel = new InteractPanel(_arg_1, this.player, 100, 100);
    ...
    private function createEquippedGridBackground():void {
        ...
        var _local_1:GraphicsSolidFill = new GraphicsSolidFill(0xF9F9F9, 3);
        ...
        GraphicsUtil.drawCutEdgeRect(0,0, 178, 46, 6, [2, 2, 2, 2], _local_2);
