...
public class StatMetersView extends Sprite {
    ...
    public function StatMetersView() {
        this.expBar_ = new StatusBar(530, 16, 5931045, 0x545454, TextKey.EXP_BAR_LEVEL);
        this.fameBar_ = new StatusBar(530, 16, 0xFCF700, 0x16578304, TextKey.CURRENCY_FAME);
