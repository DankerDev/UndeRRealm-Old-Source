...
public class TitleView extends Sprite {
    ...
    private function makeMenuOptionsBar():MenuOptionsBar {
        ...
        _local_6.addButton(_local_1, MenuOptionsBar.CENTERBOTTON);
        _local_6.addButton(_local_2, MenuOptionsBar.RIGHT);
        _local_6.addButton(_local_5, MenuOptionsBar.BOTTOM);
        _local_6.addButton(_local_3, MenuOptionsBar.LEFT);
        _local_6.addButton(_local_4, MenuOptionsBar.TOP);
        return (_local_6);
    }
    ...
    public function makeText():TextFieldDisplayConcrete {
        ...
        _local_1 = new TextFieldDisplayConcrete().setSize(14).setColor(12253439);
    ...
    private function createEditorButton():void {
        ...
        this.menuOptionsBar.addButton(_local_1, MenuOptionsBar.RIGHTER);
        this.editorClicked = _local_1.clicked;
    }

    private function makeMigrateButton():void {
        this.migrateButton = new TitleMenuOption("", 16, false);
