...
public class ButtonFactory {
    ...
    private static const LEFT:String = TextFieldAutoSize.CENTER;//"left"
    private static const CENTER:String = TextFieldAutoSize.CENTER;//"center"
    private static const RIGHT:String = TextFieldAutoSize.CENTER;//"right"
    ...
    private static var exitButton:TitleMenuOption;
    ...
    public static function getExitButton():TitleMenuOption {
        return ((exitButton = ((exitButton) || (makeButton(TextKey.EXIT_TEXT, BUTTON_SIZE_LARGE, CENTER)))));
    }
