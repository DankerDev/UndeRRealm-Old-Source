...
public class ExternalOpenMoneyWindowCommand {
    ...
    private const TESTING_ERROR_MESSAGE:String = "You cannot purchase coin on the testing server";
    private const REGISTRATION_ERROR_MESSAGE:String = "You must be registered to buy coin";
