...
public class Camera {
    ...
    public static const CENTER_SCREEN_RECT:Rectangle = new Rectangle(-400, -325, 800, 600);
    public static const OFFSET_SCREEN_RECT:Rectangle = new Rectangle(-400, -450, 800, 600);
