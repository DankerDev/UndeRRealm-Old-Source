...
public class PlayerToolTip extends ToolTip {
    ...
    public function PlayerToolTip(_arg1:Player) {
        ...
        this.hpBar_ = new StatusBar(176, 16,0, 0, 0, 0, 14693428, 0x545454, TextKey.STATUS_BAR_HEALTH_POINTS);
        this.hpBar_.x = 6;
        this.hpBar_.y = _local2;
        addChild(this.hpBar_);
        _local2 = (_local2 + 24);
        this.mpBar_ = new StatusBar(176, 16,0 ,0 ,0, 0, 6325472, 0x545454, TextKey.STATUS_BAR_MANA_POINTS);
        this.mpBar_.x = 6;
