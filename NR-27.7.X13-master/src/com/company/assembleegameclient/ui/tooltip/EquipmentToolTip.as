...
public class EquipmentToolTip extends ToolTip {
    ...
    private var priceText:TextFieldDisplayConcrete;
    ...
    private function makeCostText(): void {
        var _local1:int;
        if (this.objectXML.hasOwnProperty("Price")) {
            _local1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFFFF : 16549442);
            this.priceText = new TextFieldDisplayConcrete().setSize(12).setColor(_local1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) - 30)).setWordWrap(true);
            this.priceText.setStringBuilder(new StaticStringBuilder().setString(("Price: " + this.objectXML.Price)));
            waiter.push(this.priceText.textChanged);
    ...
    override protected function alignUI():void {
        ...
        if (this.priceText) {
            if (contains(this.priceText)) {
                this.priceText.x = 4;
                this.priceText.y = _local1;
            }
        }
    }
