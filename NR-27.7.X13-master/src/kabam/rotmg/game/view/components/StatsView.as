...
public class StatsView extends Sprite {
    ...
    public static const LUCK:int = 6;
    ...
    private function drawStats(_arg1:Player):void {
        ...
        this.stats_[LUCK].draw(_arg1.luck_,_arg1.drawnothing , _arg1.maxLuck_);
    }
