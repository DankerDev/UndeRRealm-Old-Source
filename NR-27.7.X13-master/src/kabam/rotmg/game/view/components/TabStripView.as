...
public class TabStripView extends Sprite {
    ...
    private const inventory_y:Number = -140;
    private const inventory_x:Number = 235;
    ...
    public function TabStripView(_arg1:Number = 186, _arg2:Number = 118) {
        ...
        this.containerSprite.y = inventory_y;
        this.containerSprite.x = inventory_x;
    ...
    private function selectTab(_arg1:TabView):void {
        ...
        if (_arg1) {
            ...
            else
            {
                ...
                this.background.visible = false;
                canOpen = true;
                this.contents[currentTabIndex].visible = false;
            }
        }
    }

    public function drawBackground():void {
        var _local1:GraphicsSolidFill = new GraphicsSolidFill(TabConstants.BACKGROUND_COLOR, 0.3);
        ...
        this.background.y = inventory_y;
        this.background.x = inventory_x;
    ...
    public function showContent(_arg1:int):void {
        var _local2:Sprite;
        var _local3:Sprite;
        var _selected = this.tabs[this.currentTabIndex];
