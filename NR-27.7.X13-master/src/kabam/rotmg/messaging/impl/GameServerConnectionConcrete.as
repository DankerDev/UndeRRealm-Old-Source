...
import kabam.rotmg.messaging.impl.incoming.PlayerInfoPacket;
import kabam.rotmg.ui.view.PlayerInfo;
import kabam.rotmg.ui.view.PlayerInfo;
...
public class GameServerConnectionConcrete extends GameServerConnection {
    ...
    public function mapMessages():void {
        ...
        _local1.map(SELLITEM).toMessage(SellItem);
        _local1.map(PLAYER_INFO).toMessage(PlayerInfoPacket);
    }
    ...
    private function unmapMessages():void {
        ...
        _local1.unmap(PLAYER_INFO);
        _local1.unmap(SELLITEM);
    }
