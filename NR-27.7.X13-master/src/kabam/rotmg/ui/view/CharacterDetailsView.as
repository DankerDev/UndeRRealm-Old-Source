...
public class CharacterDetailsView extends Sprite {
    ...
    private var accIdText_:TextFieldDisplayConcrete;
    ...
    public function CharacterDetailsView() {
        ...
        this.nameText_ = new TextFieldDisplayConcrete().setSize(12).setColor(0xFFFFFF);
        this.rankText_ = new TextFieldDisplayConcrete().setSize(12).setColor(0xFFFFFF);
        this.accIdText_ = new TextFieldDisplayConcrete().setSize(12).setColor(0xFFFFFF);
    ...
    public function init(_arg1:String, _arg2:String, _arg3:String, _arg4:String):void {
        this.createPortrait();
        this.createNameText(_arg1);
        this.createButton(_arg2);
        this.createRankText(_arg3);
        this.createAccIdText(_arg4);
    }
    ...
    private function createRankText(_arg1:String):void {
        this.rankText_.setBold(true);
        this.rankText_.x = this.nameText_.x;
        this.rankText_.y = this.nameText_.y + 20;
        this.setRankText(_arg1);
        addChild(this.rankText_);
    }

    private function createAccIdText(_arg1:String):void {
        this.accIdText_.setBold(true);
        this.accIdText_.x = this.rankText_.x;
        this.accIdText_.y = this.rankText_.y + 20;
        this.setAccIdText(_arg1);
        addChild(this.accIdText_);
    }
    ...
    public function setRankText(_arg1:String):void {
        this.rankText_.setStringBuilder(new StaticStringBuilder("IsAdmin: " + _arg1));
    }

    public function setAccIdText(_arg1:String):void {
        this.accIdText_.setStringBuilder(new StaticStringBuilder("AccId: " + _arg1));
    }
