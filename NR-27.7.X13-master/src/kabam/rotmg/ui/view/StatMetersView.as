...
public class StatMetersView extends Sprite {
    ...
    private var _barMask:Bitmap;
    private var _barMask2:Bitmap;

    public function StatMetersView() {
        this.expBar_ = new StatusBar(171, 20, 0, 0, 0, 0, 5931045, 0x545454, TextKey.EXP_BAR_LEVEL);
        this.fameBar_ = new StatusBar(171, 20, 0, 0, 0, 0, 0xE25F00, 0x545454, TextKey.CURRENCY_FAME);
        this.hpBar_ = new StatusBar(75, 80, 0, 0, 30, 30, 14693428, 0x545454, TextKey.STATUS_BAR_HEALTH_POINTS);
        this.mpBar_ = new StatusBar(75, 80, 0, 0, 30, 30, 6325472, 0x545454, TextKey.STATUS_BAR_MANA_POINTS);
        this._barMask = new Bitmap(new BarMask());
        this._barMask2 = new Bitmap(new BarMask());
        this.expBar_.y = 50;
        this.fameBar_.y = 50;
        this.hpBar_.x = -80;
        this.mpBar_.x = 174;
        this._barMask.x = this.hpBar_.x - 2;
        this._barMask.y = this.hpBar_.y - 3;
        this._barMask2.x = this.mpBar_.x -2;
        this._barMask2.y = this.mpBar_.y -3;
        ...
        addChild(this._barMask);
        addChild(this._barMask2);
    }
