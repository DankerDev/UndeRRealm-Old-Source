...
public class HUDView extends Sprite implements UnFocusAble {
    ...
    private const BG_POSITION:Point = new Point(2, 2);
    private const MAP_POSITION:Point = new Point(650, 2);
    private const STAT_METERS_POSITION:Point = new Point(314, 530);
    private const EQUIPMENT_INVENTORY_POSITION:Point = new Point(313, 540);
    private const TAB_STRIP_POSITION:Point = new Point(397, 500);
    ...
    public var infoBackground:Sprite;
    ...
    private function createAssets():void {
        ...
        this.miniMap = new MiniMapImp(150, 150);
    ...
    private function createEquippedGridBackground():void {
        ...
        var _local1:GraphicsSolidFill = new GraphicsSolidFill(0x8F641B, 1);
