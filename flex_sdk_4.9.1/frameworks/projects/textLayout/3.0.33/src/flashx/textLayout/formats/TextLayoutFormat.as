...
package flashx.textLayout.formats
{
	...
	public class TextLayoutFormat implements ITextLayoutFormat
	{
		...
		static public function get lineHeightProperty():Property
		{
			...
			_lineHeightProperty = Property.NewNumberOrPercentProperty("lineHeight","120%",true,Vector.<String>([Category.CHARACTER]),-8000,8000,"-8000%","8000%")
		 ...
		 * <p>Legal values as a number are from -8000 to 8000.</p>
		 * <p>Legal values as a percent are numbers from -8000% to 8000%.</p>
		 * <p>Legal values include FormatValue.INHERIT.</p>
		 * <p>Default value is undefined indicating not set.</p>
